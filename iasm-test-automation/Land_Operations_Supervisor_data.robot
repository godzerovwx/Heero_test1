...
科級主管-首頁-送審中頁面-覆核資產驗證
    ...
    Verify the testcase is pass (data is existed)    //table[@id="pr_id_3-table"]//td[contains(text(),'${has_review_hard_data_name}')]
    Wait And Click    //*[contains(text(),'${home_table_string_send}')]
    Review data    ${has_review_soft_data_name}
    Wait And Click  //img[@class='img1 tab-icon ng-star-inserted']
    Verify the testcase is pass (data is existed)    //table[@id="pr_id_3-table"]//td[contains(text(),'${has_review_soft_data_name}')]
    Wait And Click    //*[contains(text(),'${home_table_string_send}')]
    Review data    ${has_review_data_data_name}
    Wait And Click  //img[@class='img1 tab-icon ng-star-inserted']
    Verify the testcase is pass (data is existed)    //table[@id="pr_id_3-table"]//td[contains(text(),'${has_review_data_data_name}')]
    Wait And Click    //*[contains(text(),'${home_table_string_send}')]
    Review data    ${has_review_paper_data_name}
    Wait And Click  //img[@class='img1 tab-icon ng-star-inserted']
    Verify the testcase is pass (data is existed)    //table[@id="pr_id_3-table"]//td[contains(text(),'${has_review_paper_data_name}')]
    Wait And Click    //*[contains(text(),'${home_table_string_send}')]
    Review data    ${has_review_people_data_name}
    Wait And Click  //img[@class='img1 tab-icon ng-star-inserted']
    Verify the testcase is pass (data is existed)    //table[@id="pr_id_3-table"]//td[contains(text(),'${has_review_people_data_name}')]
